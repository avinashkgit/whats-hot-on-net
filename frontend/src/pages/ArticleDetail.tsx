  ...
  if (error || !article) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
        ...
        <a
          href="/"
          className="px-8 py-3 bg-primary text-primary-foreground rounded-full font-bold shadow-lg hover:shadow-xl hover:bg-primary/90 transition-all"
        >
          Back to Home
        </a>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-12">
                    ...
                    (
                      ...
                      if (idx === 0) {
                        return (
                          <p
                            key={idx}
                            className="first-letter:float-left first-letter:text-7xl first-letter:pr-4 first-letter:font-black first-letter:font-display first-letter:text-foreground"
                          >
                            {paragraph}
                          </p>
                        );
              ...
              <div className="hidden md:block">
                <div className="sticky top-32 space-y-6">
                  ...
                  <button
                    className="p-3 rounded-full bg-secondary hover:bg-primary hover:text-white transition-colors block"
                    title="Share on Twitter"
                  >
                    <Twitter className="w-5 h-5" />
                  </button>
                  <button
                    className="p-3 rounded-full bg-secondary hover:bg-[#1877F2] hover:text-white transition-colors block"
                    title="Share on Facebook"
                  >
                    <Facebook className="w-5 h-5" />
                  </button>
                  <button
                    className="p-3 rounded-full bg-secondary hover:bg-[#0A66C2] hover:text-white transition-colors block"
                    title="Share on LinkedIn"
                  >
                    <Linkedin className="w-5 h-5" />
                  </button>
                  <button
                    className="p-3 rounded-full bg-secondary hover:bg-foreground hover:text-background transition-colors block"
                    title="Copy Link"
                  >
